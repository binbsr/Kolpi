        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationHours = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectiveAnswersCount = table.Column<int>(type: "int", nullable: false),
                    ObjectiveAnswersCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExamPapersId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "QUestion just added", "New" },
                    { 2, "Question is being reviewed", "Review" },
                    { 3, "Question finalized and can be published", "Publish" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "green", "Tags that defines complexities of the question e.g. level-1, level-2 etc.", "Complexity" },
                    { 2, "orange", "Tags that defines subject categories of the question e.g. GK, GK-History, Physics etc.", "Subject" }
                });
