...
{
    public partial class DbSkeleton : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationHours = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutstandingBadges = table.Column<int>(nullable: false),
                    OutstandingBadgesIcon = table.Column<byte[]>(nullable: true),
                    ExcellentBadges = table.Column<int>(nullable: false),
                    ExcellentBadgesIcon = table.Column<byte[]>(nullable: true),
                    VeryGoodBadges = table.Column<int>(nullable: false),
                    VeryGoodBadgesIcon = table.Column<byte[]>(nullable: true),
                    GoodBadges = table.Column<int>(nullable: false),
                    GoodBadgesIcon = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
